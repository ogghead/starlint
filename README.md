...
|--------|------:|----------|--------|--------|
| express | 141 | **13ms (12 MB)** | 108ms (111 MB) | 1.47s (262 MB) |
| date-fns | 1562 | **73ms (12 MB)** | 90ms (113 MB) | 4.73s (465 MB) |
| grafana | 6201 | **309ms (18 MB)** | 393ms (133 MB) | 31.66s (561 MB) |
<details>
<summary>Full defaults (all rules enabled per tool)</summary>

| Corpus | Files | starlint | oxlint | eslint |
|--------|------:|----------|--------|--------|
| express | 141 | 95ms (20 MB) | **71ms (108 MB)** | 1.79s (250 MB) |
| date-fns | 1562 | 534ms (39 MB) | **141ms (111 MB)** | 5.91s (454 MB) |
| grafana | 6201 | 3.40s (297 MB) | **687ms (156 MB)** | 5.12s (504 MB) |
</details>
