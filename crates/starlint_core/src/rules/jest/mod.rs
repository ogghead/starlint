...
pub fn category_rules() -> Vec<Box<dyn NativeRule>> {
    vec![
        Box::new(consistent_test_it::ConsistentTestIt),
        Box::new(expect_expect::ExpectExpect),
        Box::new(max_expects::MaxExpects::new()),
        Box::new(max_nested_describe::MaxNestedDescribe),
        ...
        Box::new(no_large_snapshots::NoLargeSnapshots),
        Box::new(no_mocks_import::NoMocksImport),
        Box::new(no_restricted_jest_methods::NoRestrictedJestMethods),
        ...
        Box::new(prefer_jest_mocked::PreferJestMocked),
        ...
        Box::new(require_hook::RequireHook),
        Box::new(require_to_throw_message::RequireToThrowMessage),
        Box::new(require_top_level_describe::RequireTopLevelDescribe),
